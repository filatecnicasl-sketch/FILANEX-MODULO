"""Round 3: short AI + coding brand names."""
...
# Short names: IA (AI in Spanish) + code + nexo concepts
names = [
    # nexo + ia fusion
    "nexia", "nexai", "conexia", "konexia", "nexira",
    # codigo + ia fusion
    "codia", "kodia", "codexia", "kodexa", "codika", "kodika", "codai",
    # naxo/nexo + ia
    "naxia", "iaxo", "nexoia",
    # brain/mind/neural + ia
    "cognia", "kognia", "neuria", "synapia", "sinapia",
    # misc short brandables
    "axia", "aivia", "zenia", "synia", "lexia", "aicoda",
    "iamedida", "codexa",
]
