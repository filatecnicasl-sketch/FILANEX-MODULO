"""Round 6: unique pronounceable inventions."""
...
names = [
    # code + naxo/nexo blends
    "codaxo", "kodaxo", "codexon", "kodexon", "codnexa", "codevia", "kodeva",
    # neural + nexo
    "neuraxo", "neuraxa", "neuranex",
    # forge of AI (programacion artesanal a medida)
    "forjia", "forxia", "forgia",
    # nexo + AI + O constructions
    "nexaio", "nexaix", "nexodia", "inexo", "onexo", "nexxio", "qodexo",
    # tailor-made concept (a medida)
    "sastria", "medixia", "codira",
    # extra unique
    "nexoiq", "zynexo", "nexovai",
]
