"""Round 4: creative fusions - code+nexo, AI embedded."""
...
names = [
    # codigo + nexo fusion
    "codexo", "kodexo", "codnexo", "nexcode", "nexkode", "kodnex", "codnex",
    # AI embedded (n-AI-xo style)
    "naixo", "naixa", "nexaia", "aixon", "codaix", "devaix", "aixode",
    # nexo evolutions
    "nexova", "nexovia", "nexalia", "nexelia", "nexario", "nexaro",
    "nexius", "nexion", "nexial", "neksia", "nexsia",
    # bit / byte + nexo
    "nexobit", "bitnexo", "ianexo",
]
