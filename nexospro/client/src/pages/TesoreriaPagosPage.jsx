    ...
    >
      ...
      {pagoForm?.id === f._id ? (
        ...
        <button
          ...
          className="shrink-0 inline-flex items-center gap-1.5 text-[0.78125rem] font-semibold bg-rose-600 text-white px-3.5 py-2 rounded-lg hover:bg-rose-700 transition-colors"
        >
          <svg
            width="13"
            height="13"
    ...
    <>
      ...
      >
        <div className="inline-flex rounded-lg overflow-hidden border border-slate-300 bg-white text-[0.78125rem] font-semibold">
          ...
          <button
            ...
            className={`px-3.5 py-2 transition-colors ${vista === "proveedor" ? "seg-activo" : "text-slate-500 hover:text-slate-800 hover:bg-slate-100"}`}
          >
            Por proveedor
          </button>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
        <div className="panel px-6 py-5">
          ...
          <p className="num text-[1.625rem] font-semibold text-rose-600 mt-1.5">
