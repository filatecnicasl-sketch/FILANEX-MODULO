...
import { resolveImageSrc } from "./assets.js";
    ...
    <table className="h-full w-full" style={{ borderCollapse: "collapse", tableLayout: "fixed", border }}>
      ...
      <tbody>
        {el.groupTitle && (
          <tr style={{ height: mm(groupH) }}>
            <td
              ...
              style={{ border, textAlign: "center", fontWeight: 700, fontSize: fs(el.headerFontSize + 1), padding: 0 }}
            >
              {el.groupTitle}
            </td>
          </tr>
        ...
        <tr style={{ height: mm(headH) }}>
          ...
          {el.columns.map((c, i) => (
            <td key={i} style={{ border, textAlign: "center", fontWeight: 700, fontSize: fs(el.headerFontSize), padding: 0 }}>
              {c.title}
            </td>
          ))}
        </tr>
              ...
              <td key={c} style={{ border, padding: 0 }}>
                {variant === "fill" ? (
                  <input
                    ...
                    style={{ fontSize: fs(el.headerFontSize) }}
                  />
                ) : (
                  <div className="truncate px-0.5" style={{ fontSize: fs(el.headerFontSize) }}>
