...
// ---- Helpers para construir elementos con menos repetición ----
...
/**
 * Reproduce el "Resguardo de depósito sin presupuesto" (ejemplar para el
 * prestador del servicio) del documento original del NEXOPRO clásico.
 * Página A4 apaisada: 297 x 210 mm.
 */
export function buildRecepcionVehiculo() {
  ...
  return {
    ...
    elements: [
      ...
      tx("NOMBRE DEL TALLER", 157, 141.5, 62, 4, 7, false),
      firma("", "", 224, 140, 56, 9),
