...
const labelCls = "mb-0.5 block text-[11px] font-medium text-slate-400";
...
function PageProps({ template, onUpdateTemplate }) {
  return (
    <>
      ...
      <div className="rounded-md bg-white/5 p-2 text-[11px] leading-snug text-slate-400">
    ...
    <>
      ...
      <div>
        <div className="mb-1 flex items-center justify-between">
          ...
          <button
            className="flex items-center gap-1 rounded bg-white/10 px-1.5 py-0.5 text-[11px] text-slate-200 hover:bg-white/20"
        ...
        <div className="text-[10px] text-slate-500">El número es la fracción del ancho total de cada columna.</div>
      </div>
    </>
  );
}
