          ...
          <div className="panel p-5 mb-5 max-w-3xl">
            ...
            {estado.configurado && (
              <dl className="grid grid-cols-3 gap-4 mb-4 text-sm">
                <div>
                  <dt className="text-[10.5px] font-semibold uppercase tracking-[0.1em] text-slate-500 mb-0.5">Archivo</dt>
                  <dd className="text-white num">{estado.archivo}</dd>
                </div>
                <div>
                  <dt className="text-[10.5px] font-semibold uppercase tracking-[0.1em] text-slate-500 mb-0.5">Cargado</dt>
                  <dd className="text-white">{fechaCorta(estado.fecha)}</dd>
                </div>
                <div>
                  <dt className="text-[10.5px] font-semibold uppercase tracking-[0.1em] text-slate-500 mb-0.5">Contraseña</dt>
            ...
            <div className="mb-4">
              <span className="text-[10.5px] font-semibold uppercase tracking-[0.1em] text-slate-500 block mb-1.5">
                Entorno VeriFactu
              </span>
