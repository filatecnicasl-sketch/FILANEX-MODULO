              ...
              <tbody>
                {lista.map((p) => (
                  <tr key={p._id}>
                    <td className="max-w-[300px]">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-[11px] text-slate-400 truncate">{p.email || "Sin email"}</p>
                        </div>
                      </div>
                    </td>
                    <td className="num text-[12px] text-slate-500 whitespace-nowrap">{p.nif ?? "—"}</td>
                    ...
                    <td className="text-slate-500 whitespace-nowrap">{p.direccion?.ciudad ?? "—"}</td>
