  ...
  async function importarPdf(e) {
    ...
    try {
      ...
      if (datos.tipo === "albaran") {
        setAviso("El documento era un albarán: lo tienes en Compras → Albaranes.");
      } else {
        setAviso("Factura registrada por IA: revísala y valídala desde aquí o desde Revisión OCR.");
      }
      await cargar();
    } catch (err) {
