    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <p className="font-medium text-[#0f172a] truncate flex items-center gap-2">
          ...
          {!conIban && (
            <span className="shrink-0 text-[10px] font-bold uppercase tracking-wide px-2 py-0.5 rounded-md bg-amber-100 text-amber-600">
              sin IBAN
            </span>
          )}
          {f.remesa && (
            <span className="shrink-0 text-[10px] font-bold uppercase tracking-wide px-2 py-0.5 rounded-md bg-sky-100 text-sky-600">
              en remesa
            </span>
          )}
        </p>
      ...
      {cobroForm?.id === f._id ? (
        ...
        <button
          ...
          className="shrink-0 inline-flex items-center gap-1.5 text-[12.5px] font-semibold bg-emerald-600 text-white px-3.5 py-2 rounded-lg hover:bg-emerald-700 transition-colors"
        >
          <svg
            width="13"
            height="13"
    ...
    <>
      ...
      >
        <div className="inline-flex rounded-lg overflow-hidden border border-white/15 text-[12.5px] font-semibold">
          ...
          <button
            ...
            className={`px-3.5 py-2 transition-colors ${vista === "cliente" ? "bg-white text-slate-800" : "text-slate-300 hover:text-white"}`}
          >
            Por cliente
          </button>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
        <div className="panel px-6 py-5">
          ...
          <p className="num text-[26px] font-semibold text-emerald-600 mt-1.5">
      ...
      <h2 className="text-[15px] font-semibold text-[#0f172a] mb-3">Remesas generadas</h2>
      {remesas.length === 0 ? (
