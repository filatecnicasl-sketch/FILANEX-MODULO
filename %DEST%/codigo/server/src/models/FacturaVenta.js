...
const facturaVentaSchema = new Schema(
  {
    ...
    numero: Number,
    serieNumero: String, // número completo emitido: prefijo + número (p.ej. "A-1")
    ...
    rectifica: { type: Schema.Types.ObjectId, ref: "FacturaVenta" },
    vencimiento: Date,
...
export default model("FacturaVenta", facturaVentaSchema);
